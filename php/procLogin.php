...
if (isset($_POST['user']) && isset($_POST['contrasena'])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $hashed_password = $row['username_password'];
        ...
        if (password_verify($password, $hashed_password)) {
            ...
            echo "<script>window.location.href = '../index.php';</script>"; // Redirigimos a index.php en caso de error
            exit();
        }
    } else {
        // Usuario incorrecto
    ...
    echo "<script>window.location.href = '../index.php';</script>"; // Redirigimos a index.php si falta algún campo
    exit();
}
